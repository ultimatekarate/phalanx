pub mod world;    // The "Ether": Shared state where nodes meet
...
pub mod chaos;    // The "Adverbs": Logic for dropping/delaying packets

pub use harness::{SimulationHarness, SimConfig};
