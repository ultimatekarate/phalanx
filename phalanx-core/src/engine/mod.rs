...
use crate::protocol::shards::{VideoShard, AudioShard, Evidence, WitnessEnvelope};
use crate::network::network::PreSharedKey;
...
impl PhalanxEngine {
    pub fn new(
        ...
        let swarm = crate::network::network::setup_phalanx_swarm(
